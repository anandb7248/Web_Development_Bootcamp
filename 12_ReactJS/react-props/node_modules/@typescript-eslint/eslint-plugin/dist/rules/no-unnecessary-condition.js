...
// Nullish utilities
const nullishFlag = typescript_1.default.TypeFlags.Undefined | typescript_1.default.TypeFlags.Null;
...
exports.default = util_1.createRule({
    ...
    create(context, [{ allowConstantLoopConditions, ignoreRhs }]) {
        ...
        function checkNode(node) {
            ...
            if (tsutils_1.unionTypeParts(type).some(part => tsutils_1.isTypeFlagSet(part, typescript_1.TypeFlags.Any | typescript_1.TypeFlags.Unknown | typescript_1.default.TypeFlags.TypeParameter))) {
                return;
            }
            const messageId = tsutils_1.isTypeFlagSet(type, typescript_1.TypeFlags.Never)
                ? 'never'
